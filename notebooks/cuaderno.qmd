...
### `Análisis de Varibles Categóricas`
...
### Tipo de propiedad y áreas (distritos) - Top10
...
### **`Distribución de precios vs distrito- Top 10`** 
...
### **`Pregunta6: ¿Cómo se distribuyen geográficamente los listados de Airbnb en Madrid y qué áreas muestran mayor concentración de alojamientos?`**
...
### **`Pregunta: ¿Qué variables están más fuertemente correlacionadas con el precio de los alojamientos en Airbnb?`**
...
**Correlación entre "Room.Price" y otras variables**:
