...
Como hemos visto arriba, hay dos columnas que deberían ser de diferente clase.
    ...
    Review_category = factor(
      if_else(
        ...
        cut(  # Función cut para categorizar los valores no NA y no cero
          ...
          breaks = c(0, 1, 5, 10, Inf),  # Puntos de corte para las categorías
          labels = c('0-1/mes', '1-5/mes', '5-10/mes', '+10/mes'),  # Etiquetas para cada rango
          include.lowest = TRUE,
          right = TRUE
        )
      ),
      levels = c('sin reseñas', '0-1/mes', '1-5/mes', '5-10/mes', '+10/mes')  # Definiendo el orden de los niveles del factor
    )
  )
