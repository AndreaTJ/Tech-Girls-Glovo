...
-   *Date.last.review* - Se ha hecho una Resta entre Fecha del Scrapping(Updated.Date) y *Date.last.review*. El resultado se guarda en *Time_category* y se categorizada en rangos de tiempo:
...
ggplot(airbnb_data, aes(x = Time_category)) +
  ...
  labs(title = "Distribución de Time_category (Resta entre Updated.Date y Date.last.review)", x = "Time_category", y = "Frecuencia")
