...
airbnb_data <- airbnb_data %>%
  mutate(
    check = is.na(Date.last.review) & Number.of.reviews == 0 &  is.na(Number.of.reviews.per.month)
  )
...
Podemos concluir que siempre que `Date.last.review` es nulo,`Number.of.reviews`
